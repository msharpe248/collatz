...
The next useful advance needs an independent restriction on the number
of defects, or a sharper bound on the time available between defects.
The expanded audit checks 35 selected declarations using only Lean's
...
\code{lean/Collatz/ParityDefects.lean}; the research note is
