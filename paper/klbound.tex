...
the $3x+1$ problem. The companion repository contains a Lean~4
formalization of related results (Terras' theorem in finite form among
them) where the required infrastructure already exists
\cite{companion}.
