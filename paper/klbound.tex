...
$k = 12, \dots, 17$. Separately, a Lean~4 formalization of an
integer-grid weakening of the method now carries machine verification
past the problem's critical constant: a kernel-checked proof that
$\pi_1(x) = \Omega(x^{\gamma})$ with
$\gamma = 50\log_2(1261/1250) = 0.632009\ldots > \log 2/\log 3$
...
before Applegate--Lagarias \cite{applegate-lagarias}; scaling the
formal pipeline onward toward the present paper's $0.895$ certificates
is mechanical in principle.
