...
$x^{0.8569}$ of the integers below $x$ reach $1$ --- above the
twenty-year-old published record $x^{0.84}$ (a first run at a smaller
level gave $x^{0.8476}$).
...
The certificate --- $531{,}441$ integers, one per congruence class mod
$3^{13}$ --- is stored inside the proof as $243$ very large numbers and
checked, class by class, by Lean's kernel in a little over two hours. Nothing is trusted from outside.
